...
export const leaderboard: LeaderboardEntry[] = [
  ...
  },
  {
    ...
    tokens_trained: '200M',
    components: {
      loss_recovered: 0.998,
      alive: 0.999,
      l0_score: l0ScoreFromL0(128),
      sparse_probing: 0.862,
      tpp: 0.135,
    },
    interp_score: 0,
    submitted_at: '2026-04-24',
    submitted_by: 'caiovicentino1',
    notebook_version: '18b_interpscore_qwen36_27b_papergrade · v0.0.1',
    notes: 'Best of 3-layer paper-grade release. InterpScore eval: 250k tokens C4, probes toxicity (SetFit/toxic_conversations) + sentiment (sst2), TPP at 0.5% of d_sae (k=327).',
  },
  {
    sae_repo: 'caiovicentino1/qwen36-27b-sae-papergrade',
    model: 'Qwen/Qwen3.6-27B',
    ...
    tokens_trained: '200M',
    components: {
      loss_recovered: 0.994,
      alive: 0.892,
      l0_score: l0ScoreFromL0(128),
      sparse_probing: 0.867,
      tpp: 0.117,
    },
    interp_score: 0,
    submitted_at: '2026-04-24',
    submitted_by: 'caiovicentino1',
    notebook_version: '18b_interpscore_qwen36_27b_papergrade · v0.0.1',
    notes: 'Middle-stack residual. Probing slightly stronger than L11; TPP and alive lower (consistent with Lieberum middle-layer harder-to-reconstruct finding).',
  },
  {
    sae_repo: 'caiovicentino1/qwen36-27b-sae-papergrade',
    model: 'Qwen/Qwen3.6-27B',
    ...
    tokens_trained: '200M',
    components: {
      loss_recovered: 0.988,
      alive: 0.780,
      l0_score: l0ScoreFromL0(128),
      sparse_probing: 0.829,
      tpp: 0.242,
    },
    interp_score: 0,
    submitted_at: '2026-04-24',
    submitted_by: 'caiovicentino1',
    notebook_version: '18b_interpscore_qwen36_27b_papergrade · v0.0.1',
    notes: 'Late-stack residual. Highest TPP of the three layers (0.242 — features more concentrated). Alive lower because eval window is 250k tokens (held-out 1M shows 0.888).',
  },
  {
