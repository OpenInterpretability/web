...
export const supplementary: SupplNotebook[] = [
  ...
  {
    kind: 'guard',
    title: 'ReasonGuard v0.1 — probe during thinking',
    tagline: 'AUROC 0.888 within math · 0.605 cross-domain · honest narrow scope',
    icon: Brain,
    description:
    ...
    estimatedTime: '~6h on RTX 6000 (rollouts + training, resumable)',
    platform: 'Colab Pro+ · ≥48 GB VRAM',
    difficulty: 'advanced',
  ...
  {
    kind: 'guard',
    title: 'ReasonGuard v0.2 — multi-bench combined training',
    tagline: 'FabricationGuard methodology applied to reasoning · cross-bench transfer test',
    icon: Brain,
    description:
    ...
    estimatedTime: '~5 min · Colab Free (CPU-only)',
    platform: 'Any · sklearn only',
    difficulty: 'intermediate',
    notebookPath: '34_reasonguard_v0_2_multibench.ipynb',
    githubUrl: `${GITHUB_BASE}/34_reasonguard_v0_2_multibench.ipynb`,
    colabUrl: colabFor('34_reasonguard_v0_2_multibench.ipynb'),
  },
  {
    kind: 'guard',
    title: 'Multi-Probe DPO POC — Qwen3.6-27B + FG + RG',
    tagline: 'First OSS multi-probe-reward DPO on 27B · Goodfire RLFR pattern + orthogonal probes',
    icon: Brain,
    description:
    ...
    estimatedTime: '~2h · Colab Pro+ RTX 6000',
    platform: 'Colab Pro+ · ≥80 GB VRAM',
    difficulty: 'advanced',
    notebookPath: '35_multiprobe_dpo_poc.ipynb',
    githubUrl: `${GITHUB_BASE}/35_multiprobe_dpo_poc.ipynb`,
    colabUrl: colabFor('35_multiprobe_dpo_poc.ipynb'),
  },
  {
    kind: 'guard',
    title: 'Anti-Goodhart fresh-probe validation',
    tagline: '4-quadrant verdict · distinguishes real improvement from probe evasion',
    icon: Brain,
    description:
    ...
    estimatedTime: '~30 min · Colab Pro+ RTX 6000',
    platform: 'Colab Pro+ · ≥80 GB VRAM',
    difficulty: 'advanced',
    notebookPath: '36_antigoodhart_validation.ipynb',
    githubUrl: `${GITHUB_BASE}/36_antigoodhart_validation.ipynb`,
    colabUrl: colabFor('36_antigoodhart_validation.ipynb'),
  },
  // Lenses
  {
    kind: 'lens',
