...
export const papers: PaperMeta[] = [
  ...
  },
  {
    ...
    authors: "Caio Vicentino",
    orcid: CAIO_ORCID,
    venue: "Zenodo · CC-BY-4.0 · DOI 10.5281/zenodo.20368600 · the foundation of the WANDERING arc",
    status: "published",
    date: "2026-05-24",
    abstract:
    ...
    artifacts: [
      { label: "Paper PDF + permanent DOI (Zenodo, CC-BY-4.0)", href: "https://doi.org/10.5281/zenodo.20368600" },
  ...
  },
  {
    ...
    artifacts: [
      ...
      { label: "Arc PDFs mirror (HF dataset)", href: "https://huggingface.co/datasets/caiovicentino1/wandering-arc-papers" },
      { label: "Companion — Tool-Entropy Collapse (#1)", href: "https://doi.org/10.5281/zenodo.20368600" },
    ],
  ...
  },
  {
    ...
    authors: "Caio Vicentino",
    orcid: CAIO_ORCID,
    venue: "Zenodo · CC-BY-4.0 · DOI 10.5281/zenodo.20500053 · companion note to the WANDERING arc",
    status: "published",
    date: "2026-06-01",
    abstract:
    ...
    artifacts: [
      { label: "Note PDF + permanent DOI (Zenodo, CC-BY-4.0)", href: "https://doi.org/10.5281/zenodo.20500053" },
  ...
  },
  {
    ...
    authors: "Caio Vicentino",
    orcid: CAIO_ORCID,
    venue: "Zenodo · CC-BY-4.0 · DOI 10.5281/zenodo.20534219 · the first positive of the WANDERING arc",
    status: "published",
    date: "2026-06-03",
    abstract:
      "After five papers locating where control over a long-horizon agent's termination is NOT — not the residual, not the right locus, not the named verdict feature — this paper locates where it IS. On 99 Qwen3.6-27B SWE-bench Pro trajectories, reconstructed faithfully at the decision point and gated for behavioral fidelity (P(finish): SUCCESS 0.59 ≫ WANDERING 0.07 ≫ LOCKED 0.005), a layer-resolved logit-lens shows the finish decision is invisible through layer 31 and emerges only in the last ~12 of 64 layers (L51–L63), ~30 layers downstream of the mid-layer verdict (L23). Activation patching confirms it causally: injecting the SUCCESS late-block state into WANDERING raises P(finish) (+0.13 at L55, +0.15 at L59; donor-specific — the LOCKED donor moves it the other way), while every mid-layer and verdict-feature intervention is null. Critically, the effect survives a real generation: patching the late block at the decision point alone makes the agent emit a well-formed finish call in 42% of WANDERING decision points (5/12; exact one-sided McNemar p=0.031 vs a 0/12 baseline and a 0/12 LOCKED-donor null) — but only with a task-matched donor; a coarse class mean is not significant (25%, p=0.125). The first internal causal lever of the arc, it reframes the knowledge–action gap on agents as a LAYER gap: the decision is known mid-stream but only writable late. Released with decision-locator, a model-agnostic tool that finds and steers the commitment layer for any tool-calling decision on any open model. Honest scope: single model, single task family, n=12; the positive depends on the task-matched donor.",
    artifacts: [
      { label: "Paper PDF + permanent DOI (Zenodo, CC-BY-4.0)", href: "https://doi.org/10.5281/zenodo.20534219" },
      { label: "decision-locator tool (model-agnostic, pip-installable)", href: "https://github.com/OpenInterpretability/decision-locator" },
      { label: "Pre-registration + figure code + notebooks + pre-mint eval (GitHub)", href: "https://github.com/OpenInterpretability/openinterp-swebench-harness/tree/main/paper/breakthrough" },
      { label: "Transcripts + labels + residual bundle (HF dataset)", href: "https://huggingface.co/datasets/caiovicentino1/swebench-phase6-verdict-circuit" },
      { label: "Arc PDFs mirror (HF dataset)", href: "https://huggingface.co/datasets/caiovicentino1/wandering-arc-papers" },
    ],
