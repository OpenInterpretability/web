...
export const papers: PaperMeta[] = [
  ...
  },
  {
    ...
    artifacts: [
      ...
      { label: "decision-locator tool (model-agnostic, GitHub)", href: "https://github.com/OpenInterpretability/openinterp-swebench-harness/tree/main/tools/decision_locator" },
